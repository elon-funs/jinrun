...
class ApigoodsController extends CommonController {
	...
	**/
    ...
    public function get_goods_detail() {
		...
		//string(469) "活动时间：@EOF@1.参与活动人人有奖，一等奖为本商品（1 人），参与奖退款并赠送专属优惠券 。@EOF@2.只有参加拼团，而且拼团成功的用户，才有资格参与抽奖@EOF@3.活动结束后24小时内，从有资格抽奖的用户中，随机抽取中奖者 。@EOF@4.抽奖活动结束后，中奖商品3天内发货，参与奖专属优惠券3天内发放。@EOF@5.本活动真实有效，最终解释权归金润所有。"
