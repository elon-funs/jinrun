...
class IndexController extends CommonController {
	...
	public function test_sql()
	{
		...
		/**
		$res =  check_db_field_exist( 'jrs_lionfish_community_head_commiss_order','fen_type' );
		if( !$res )
		{
			$sql_content ="
			 ALTER TABLE `jrs_lionfish_community_head_commiss_order` ADD `fen_type` TINYINT(1) NULL DEFAULT '0' COMMENT '0,按照比例计算的，1按照实际金额计算的' AFTER `type`;
			";
	...
	public function test()
	{
	    ...
	    $res = D('Seller/User')->send_wxtemplate_msg( array() ,$url,$pagepath,'o10mf4omdrxYC4FboFDei2YWZlj8',$template_id,'', 0,$wx_template_data);
