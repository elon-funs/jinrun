...
class ExcelModel{
	...
	public function export_delivery_goodslist( $list, $params = array() )
	{
		...
		$excel->getProperties()->setCreator('金润商城')->setLastModifiedBy('金润商城')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
